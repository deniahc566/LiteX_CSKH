...
def _populate_sheet_real(ws, data: list[dict], kh_active: int, product_name: str = "", prev_ty_le: dict[str, float] | None = None) -> dict[str, float]:
...
def build_report_real(
    ...
    """Build bc_cskh (thật) report. Returns (Excel bytes, cur_ty_le_all)."""
    ...
    for sheet_name, data in products.items():
        ...
        cur_ty_le_all[sheet_name] = _populate_sheet_real(
